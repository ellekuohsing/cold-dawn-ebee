...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cold-dawn-ebee)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cold-dawn-ebee
```

A live public deployment of this template is available at [https://cold-dawn-ebee.templates.workers.dev](https://cold-dawn-ebee.templates.workers.dev)
